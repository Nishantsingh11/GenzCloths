        ...
        <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
            <nav className="flex flex-wrap justify-center -mx-5 -my-2">
                ...
                <div className="px-5 py-2">
                    <button className="text-base leading-6 text-gray-500 hover:text-gray-900">
                        About
                    </button>
                </div>
                </Link>
                ...
                <div className="px-5 py-2">
                    <Link to ="/term" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                        Terms
                    </Link>
                </div>
            </nav>
            <div className="flex justify-center mt-8 space-x-6">
                ...
                <a href="www.google.com" className="text-gray-400 hover:text-gray-500">
