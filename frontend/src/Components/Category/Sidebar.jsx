  ...
  const Sidebar = ({maincategory, subcategory}) => {
          ...
          <div>
                      ...
                      <div className="pt-6" id="filter-section-mobile-1">
                        <div className="space-y-6">
                          <div className="flex items-center">
                            ...
                            <label htmlFor="filter-mobile-category-0" className="ml-3 min-w-0 flex-1 text-gray-500">new </label>
                          </div>
                          <div className="flex items-center">
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900">{maincategory}  &gt;  {subcategory}</h1>

                <div className="flex items-center">
                  <div className="relative inline-block text-left">
                    <div>
                      <button type="button" className="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900" id="menu-button" aria-expanded="false" aria-haspopup="true" onClick={handleFilterToggle}>
                        Sort
                      ...
                      isFilterOpen && (
                        ...
                        <div className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1">
                          <div className="py-1" role="none">
                            ...
                            <button className="text-gray-500 block px-4 py-2 text-sm" role="menuitem" tabIndex="-1" id="menu-item-3" onClick={()=>handleOrder("ascending")} >Price: Low to High</button>
                            <button className="text-gray-500 block px-4 py-2 text-sm" role="menuitem" tabIndex="-1" id="menu-item-4"onClick={()=>handleOrder("descending")}  >Price: High to Low</button>
                          </div>
                        </div>
                      )}
                  </div>
              ...
              <section aria-labelledby="products-heading" className="pb-24 pt-6">
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                      ...
                      <div className="pt-6" id="filter-section-1">
                        <div className="space-y-4">
                          <div className="flex items-center">
                            ...
                            <label htmlFor="filter-category-0" className="ml-3 text-sm text-gray-600">new ar</label>
                          </div>
                          <div className="flex items-center">
                  ...
                  <div className="lg:col-span-3">
                      <ProductList maincategory={{maincategory}} subcategory={{subcategory}} order = {isOrder}/>
                  </div>
                </div>
              </section>
            </main>
