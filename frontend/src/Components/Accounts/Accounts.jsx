    ...
    useEffect(() => {
        axios.get("http://localhost:8080/user/getuserdetails", config)
            .then((res) => {
                ...
                setIsDataLoad(false); // Move this line inside the callback

            })
            .catch((err) => {
                console.log(err);
                setIsDataLoad(false); // Move this line inside the error callback
                                                ...
                                                <div className="grid md:grid-cols-2 text-sm">
                                                    <div className="grid grid-cols-2">
                                                        ...
                                                        {isEditable ? (
                                                            ...
                                                            <div className="px-4 py-2 font-bold text-center">{userData.firstName}</div>
                                                        )}
                                                    </div>
                                                    <div className="grid grid-cols-2">
                                                        ...
                                                        {isEditable ? (
                                                            ...
                                                            <div className="px-4 py-2 font-bold text-center">{userData.lastName}</div>
                                                        )}
                                                            ...
                                                            <div className="relative inline-block text-left">
                                                                <div>
                                                                    <button type="button" className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50" id="menu-button" aria-expanded="true" aria-haspopup="true" onClick={handleGenderOpen}>
                                                                        {userData.gender ? userData.gender : "Select Gender"}
                                                    ...
                                                    <div className="grid grid-cols-2">
                                                        ...
                                                        {isEditable ? (
                                                            ...
                                                            <div className="px-4 py-2 text-center font-bold">{userData.phoneNumber}</div>
                                                        )}
                                                    </div>
                                                    <div className="grid grid-cols-2">
                                                    ...
                                                    <div className="grid grid-cols-2">
                                                        ...
                                                        {isEditable ? (
                                                            ...
                                                            <div className="px-4 py-2">{userData?.address?.pincode}</div>
                                                        )}
                                                    </div>
                                                    <div className="grid grid-cols-2">
                                                    ...
                                                    <div className="grid grid-cols-2">
                                                        ...
                                                        {isEditable ? (
                                                            ...
                                                            <div className="px-4 py-2">
                                                                <a className="text-blue-800" href= {`mailto:${userData ? 
                                                                userData.email :"example@gmail.com"}`}>{userData ? userData.email :"Enter Email"}</a>
                                                            </div>
                                                        )
                                                    ...
                                                    <div className="grid grid-cols-2">
                                                        <div className="px-4 py-2 font-semibold">Birthday</div>
                                                        {
                                                            isEditable ? (
                                                                ...
                                                                <div className="px-4 py-2">{userData ? userData.dateOfBirth : "Select Data"}</div>
                                                            )}
                                                    </div>
                                                </div>
                                            </div>
